...
declare const _default: ((config: {
    ...
    otp: {
        ...
        signIn: Deliveries<{
            ...
            im: (loginId: string, loginOptions?: LoginOptions, token?: string) => Promise<SdkResponse<MaskedPhone>>;
        ...
        signUp: Deliveries<{
            ...
            im: (loginId: string, user?: User, signUpOptions?: SignUpOptions) => Promise<SdkResponse<MaskedPhone>>;
    ...
    magicLink: {
        ...
        signIn: Deliveries<{
            ...
            im: (loginId: string, URI: string, loginOptions?: LoginOptions, token?: string) => Promise<SdkResponse<MaskedPhone>>;
        ...
        signUp: Deliveries<{
            ...
            im: (loginId: string, URI: string, user?: User, signUpOptions?: SignUpOptions) => Promise<SdkResponse<MaskedPhone>>;
        ...
        signUpOrIn: Deliveries<{
            ...
            im: (loginId: string, URI?: string, signUpOptions?: SignUpOptions) => Promise<SdkResponse<MaskedPhone>>;
    ...
    enchantedLink: {
        ...
        signIn: (loginId: string, URI?: string, args_2?: LoginOptions & {
            providerId?: string;
        }, token?: string) => Promise<SdkResponse<EnchantedLinkResponse>>;
        signUpOrIn: (loginId: string, URI?: string, args_2?: SignUpOptions & {
            providerId?: string;
        }) => Promise<SdkResponse<EnchantedLinkResponse>>;
        signUp: (loginId: string, URI?: string, user?: User, args_3?: SignUpOptions & {
            providerId?: string;
        }) => Promise<SdkResponse<EnchantedLinkResponse>>;
    ...
    saml: {
        start: (tenantIdOrEmail: string, redirectUrl?: string, loginOptions?: LoginOptions, token?: string, ssoId?: string, forceAuthn?: boolean, loginHint?: string, enforceInitiatedEmail?: boolean) => Promise<SdkResponse<URLResponse>>;
        exchange: (code: string) => Promise<SdkResponse<JWTResponse>>;
    };
    totp: {
    ...
    notp: {
        signUpOrIn: (loginId?: string, args_1?: SignUpOptions & {
            providerId?: string;
        }) => Promise<SdkResponse<NOTPResponse>>;
        signUp: (loginId?: string, user?: User, args_2?: SignUpOptions & {
            providerId?: string;
        }) => Promise<SdkResponse<NOTPResponse>>;
        signIn: (loginId?: string, args_1?: LoginOptions & {
            providerId?: string;
        }, token?: string) => Promise<SdkResponse<NOTPResponse>>;
        waitForSession: (pendingRef: string, config?: WaitForSessionConfig) => Promise<SdkResponse<JWTResponse>>;
    };
    webauthn: {
        signUp: {
    ...
    password: {
        signUp: (loginId: string, password: string, user?: User, args_3?: SignUpOptions & {
            providerId?: string;
        }) => Promise<SdkResponse<JWTResponse>>;
        signIn: (loginId: string, password: string, args_2?: LoginOptions & {
            providerId?: string;
        }) => Promise<SdkResponse<JWTResponse>>;
    ...
    flow: {
        start: (flowId: string, options?: Options, conditionInteractionId?: string, interactionId?: string, componentsVersion?: string, flowVersions?: Record<string, number>, input?: FlowInput, isCustomScreen?: any) => Promise<SdkResponse<FlowResponse>>;
        next: (executionId: string, stepId: string, interactionId: string, version?: number, componentsVersion?: string, input?: FlowInput, isCustomScreen?: any) => Promise<SdkResponse<FlowResponse>>;
    };
