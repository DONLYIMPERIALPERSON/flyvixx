...
declare type RunManagementFlowResponse = {
...
declare type AttributesTypes = string | boolean | number | string[] | null;
...
declare type OIDCRoleMapping = Array<{
    roleName: string;
    groups: string[];
}>;
...
declare type PatchUserBatchResponse = {
...
declare type ProjectEnvironment = 'production';
...
declare type FetchOutboundAppUserTokenRequest = {
    appId: string;
    userId: string;
    scopes: string[];
...
declare type OutboundAppTokenResponse = {
    token: OutboundAppToken;
};
declare type FetchLatestOutboundAppUserTokenRequest = {
    appId: string;
    userId: string;
    tenantId?: string;
    options?: FetchOutboundAppTokenOptions;
};
declare type FetchOutboundAppTenantTokenRequest = {
    appId: string;
    tenantId: string;
    scopes: string[];
    options?: FetchOutboundAppTokenOptions;
};
declare type FetchLatestOutboundAppTenantTokenRequest = {
    appId: string;
    tenantId: string;
    options?: FetchOutboundAppTokenOptions;
};
...
declare type DescoperRole = 'admin' | 'developer' | 'support' | 'auditor';
declare type DescoperAttributes = {
    displayName?: string;
    email?: string;
    phone?: string;
};
declare type DescoperTagRole = {
    tags?: string[];
    role?: DescoperRole;
};
declare type DescoperProjectRole = {
    projectIds?: string[];
    role?: DescoperRole;
};
declare type DescoperRBAC = {
    isCompanyAdmin?: boolean;
    tags?: DescoperTagRole[];
    projects?: DescoperProjectRole[];
};
declare type Descoper = {
    id?: string;
    loginIds?: string[];
...
declare type DescoperCreate = {
    loginId?: string;
    attributes?: DescoperAttributes;
    sendInvite?: boolean;
    rbac?: DescoperRBAC;
};
declare type MgmtKeyStatus = 'active' | 'inactive';
declare type MgmtKeyReBac = {
    companyRoles?: string[];
    projectRoles?: MgmtKeyProjectRole[];
    tagRoles?: MgmtKeyTagRole[];
};
declare type MgmtKeyTagRole = {
    tags: string[];
    roles: string[];
};
declare type MgmtKeyProjectRole = {
    projectIds: string[];
    roles: string[];
};
declare type MgmtKey = {
    id: string;
    name: string;
    description?: string;
...
declare type MgmtKeyCreateResponse = {
    key: MgmtKey;
    cleartext: string;
};
...
declare const nodeSdk: {
    ({ authManagementKey, managementKey, publicKey, fgaCacheUrl, ...config }: NodeSdkArgs): {
        ...
        management: {
            user: {
                ...
                loadUsers: (userIds: string[], includeInvalidUsers?: boolean) => Promise<SdkResponse<_descope_core_js_sdk.UserResponse[]>>;
            ...
            inboundApplication: {
                ...
                getApplicationSecret: (id: string) => Promise<SdkResponse<InboundApplicationSecretResponse>>; /** Fetch the public keys (JWKs) from Descope for the configured project */
            ...
            jwt: {
                ...
                anonymous: (customClaims?: Record<string, any>, selectedTenant?: string, refreshDuration?: number) => Promise<SdkResponse<{
                    ...
                    claims: _descope_core_js_sdk.Claims;
                    trustedDeviceJwt?: string;
                    nextRefreshSeconds?: number;
                }>>;
                generateClientAssertionJwt: (issuer: string, subject: string, audience: string[], expiresIn: number, flattenAudience?: boolean, algorithm?: "RS256" | "RS384" | "ES384") => Promise<SdkResponse<ClientAssertionResponse>>;
            };
            permission: {
            ...
            descoper: {
                create: (descopers: DescoperCreate[]) => Promise<SdkResponse<{
                    descopers: Descoper[];
                    total: number;
                }>>;
                update: (id: string, attributes?: DescoperAttributes, rbac?: DescoperRBAC) => Promise<SdkResponse<Descoper>>;
            ...
            managementKey: {
                create: (name: string, reBac: MgmtKeyReBac, description?: string, expiresIn?: number, permittedIps?: string[]) => Promise<SdkResponse<MgmtKeyCreateResponse>>;
                update: (id: string, name: string, description: string, status: MgmtKeyStatus, permittedIps?: string[]) => Promise<SdkResponse<MgmtKey>>;
        ...
        validateSession: (sessionToken: string, options?: VerifyOptions) => Promise<AuthenticationInfo>;
        refreshSession: (refreshToken: string, options?: VerifyOptions) => Promise<RefreshAuthenticationInfo>;
        validateAndRefreshSession: (sessionToken?: string, refreshToken?: string, options?: VerifyOptions) => Promise<RefreshAuthenticationInfo>;
        exchangeAccessKey: (accessKey: string, loginOptions?: AccessKeyLoginOptions, options?: VerifyOptions) => Promise<AuthenticationInfo>;
        ...
        otp: {
            verify: {
                ...
                im: (loginId: string, code: string) => Promise<SdkResponse<JWTResponse & {
                    refreshJwt?: string;
                    cookies?: string[];
                }>>;
            ...
            signIn: {
                ...
                im: (loginId: string, loginOptions?: _descope_core_js_sdk.LoginOptions, token?: string) => Promise<SdkResponse<{
                    maskedPhone: string;
                }>>;
            ...
            update: {
                ...
                phone: {
                    ...
                    im: <T_1 extends boolean>(loginId: string, phone: string, token?: string, updateOptions?: {
                        addToLoginIDs?: T_1;
                        onMergeUseExisting?: T_1 extends true ? boolean : never;
                        templateOptions?: {
                            [x: string]: string;
        ...
        magicLink: {
            ...
            signIn: {
                ...
                im: (loginId: string, URI: string, loginOptions?: _descope_core_js_sdk.LoginOptions, token?: string) => Promise<SdkResponse<{
                    maskedPhone: string;
                }>>;
            ...
            update: {
                ...
                phone: {
                    ...
                    im: <T_3 extends boolean>(loginId: string, phone: string, URI?: string, token?: string, updateOptions?: {
                        addToLoginIDs?: T_3;
                        onMergeUseExisting?: T_3 extends true ? boolean : never;
                        templateOptions?: {
                            [x: string]: string;
